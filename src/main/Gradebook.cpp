...
int main(int argc, char** argv)
{
    ...
    std::cout << "Retrieving node value: " 
              << test->get_value("English") 
              << "\n";
    std::cout << "Retrieving value for node that doesn't exist: " 
              << test->get_value("Math") 
              << "\n";
    std::cout << "Deleting node returns its value: " 
    ...
    Gradebook::StudentLinkedList* english_grades = 
            new Gradebook::StudentLinkedList();
    english_grades->push(94.8);
    english_grades->push(72.5);
    english_grades->push(99);

    Gradebook::StudentLinkedList* math_grades = 
            new Gradebook::StudentLinkedList();
    math_grades->push(100);
    math_grades->push(78.7);
    math_grades->push(94.2);
    ...
    student_gradebook->insert_node("English", english_grades);
    Gradebook::StudentLinkedList* read_grades = 
            student_gradebook->get_value("English");
    std::cout << read_grades->get_size() << "\n";
